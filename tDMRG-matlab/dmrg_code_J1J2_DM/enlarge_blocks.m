...
global Sops J1 J2 D1 D2 HH DM SopL SopR N Nop tisweep
...
opLe{9}=kron(opL{9},Sops{1}) ...
        + J1* ( 0.5*( kron(opL{2},Sops{3})+kron(opL{3},Sops{2}) )+ D1*kron(opL{4},Sops{4}) )...
        + DM* ( 1i*0.5*( kron(opL{2},Sops{3})-kron(opL{3},Sops{2}) ) )...
        + HH(1)*(opLe{2}+opLe{3})/2 ...
        + J2* ( 0.5*( kron(opL{5},Sops{3})+kron(opL{6},Sops{2}) )+ D2*kron(opL{7},Sops{4}) );
...
opRe{9}=kron(Sops{1},opL{9}) ...
        + J1* ( 0.5*( kron(Sops{3},opR{2})+kron(Sops{2},opR{3}) )+ D1*kron(Sops{4},opR{4}) )...
        + DM* ( 1i*0.5*( kron(Sops{3},opR{2})-kron(Sops{2},opR{3}) ) )...
        + HH(1)*(opRe{2}+opRe{3})/2 ...
        + J2* ( 0.5*( kron(Sops{3},opR{5})+kron(Sops{2},opR{6}) )+ D1*kron(Sops{4},opR{7}) ) ;

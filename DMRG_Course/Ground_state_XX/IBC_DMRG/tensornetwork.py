...
def time_evolution(l,G,H,BC,delta,numsteps):
    ...
    disc = 0.0; temp=0.0
    l, G, temp = evolve_bonds(l, G, expH2, evenbonds ,BC); disc += temp
    ...
    l, G, temp = evolve_bonds(l, G, expH1, oddbonds  ,BC); disc += temp
    l, G, temp = evolve_bonds(l, G, expH2, evenbonds ,BC); disc += temp
...
#        evolve_bonds
###############################
def evolve_bonds(l,G,expH,bonds,BC):
    L    = len(G)
    disc = 0.0
    for pos in bonds:
        posM  = np.mod(pos-1,L)

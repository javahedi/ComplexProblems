...
def Hamil(t,U,Density_up,Density_down,k):
    ...
    Huu = np.array([[f3+U*Density_down[0]-U/2, f0+f1+f2+f4],
                    [g0+g1+g2+g4, f3+U*Density_down[1]-U/2]])

    # elements of 4x4 down matrix
    Hdd = np.array([[f3+U*Density_up[0]-U/2, f0+f1+f2+f4],
                    [g0+g1+g2+g4, f3+U*Density_up[1]-U/2]])

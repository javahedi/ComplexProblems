...
for i in range(N_samples):
    ...
    print(f'loop {i}, time : {time.time()-start}',flush=True)
#
...
f1.write('Temperature,  F    <E>     <E^2>    Cv    entropy   dE_LT      dE2_LT\n')
f1.write('============================================\n')
...
cte=0  
for t in T:
    f1.write('%f   %f   %f    %f    %f   %f   %f    %f\n'%(t, freeEnergy_FT[cte], E_FT[cte], E2_FT[cte], cv_FT[cte], entropy_FT[cte], dE_LT[cte], dE2_LT[cte]))
